...
const HeroSearch = ({ onSearch, compact, onCollapse }) => {
  const [searchQuery, setSearchQuery] = useState('');

  const handleSubmit = (e) => {
    e.preventDefault();
    onSearch({ q: searchQuery.trim() || undefined });
  };
    ...
    <div className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 overflow-hidden">
      {onCollapse && (
        <button
          ...
          className="absolute top-3 right-3 z-10 text-gray-300 hover:text-white p-2 rounded-full hover:bg-white/10 transition-colors"
        >
