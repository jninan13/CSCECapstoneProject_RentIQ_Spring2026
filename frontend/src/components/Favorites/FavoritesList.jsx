  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
        <div className="text-xl text-gray-600 dark:text-gray-400">Loading favorites...</div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-8 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-8">My Favorite Properties</h1>
        ...
        {favorites.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300">No favorite properties yet</p>
